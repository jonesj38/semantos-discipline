---
source_path: /home/jake/.edwinpai/disciplines/semantos/state/semantos-core-repo/archive/packages-jam_experience/lib/src/pad_grid.dart
source_type: folder
memory_type: semantic_memory
ingested_at: 2026-06-13T06:27:18.814655+00:00
---

# archive/packages-jam_experience/lib/src/pad_grid.dart
...
/// PadGrid — 8×8 polymorphic pad surface that renders the rhythm /
/// melody / bass layout depending on [activeRack]. Migrated from
/// `apps/world-apps/jam-room-mobile/lib/src/jam/pad_grid.dart`.
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          color: pad.dim
              ? pad.bg.withValues(alpha: 0.32)
              : pad.locked
                  ? pad.bg.withValues(alpha: 0.12)
                  : pad.bg,
          border: Border.all(
            color: pad.lit ? pad.border : pad.border.withValues(alpha: 0.5),
          ...
          boxShadow: pad.lit
              ? [
                  BoxShadow(
                    color: pad.bg.withValues(alpha: 0.45),
                    blurRadius: 10,
                    spreadRadius: -2,
                  ),
                ]
