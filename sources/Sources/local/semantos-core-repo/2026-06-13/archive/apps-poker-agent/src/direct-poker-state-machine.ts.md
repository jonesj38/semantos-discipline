---
source_path: /home/jake/.edwinpai/disciplines/semantos/state/semantos-core-repo/archive/apps-poker-agent/src/direct-poker-state-machine.ts
source_type: folder
memory_type: semantic_memory
ingested_at: 2026-06-13T06:27:18.762702+00:00
---

# archive/apps-poker-agent/src/direct-poker-state-machine.ts
  ...
  async init(gameId: string, _opponentPubKey?: string): Promise<void> {
    ...
    if (!this.validator) {
      try {
        ...
        this.validator = new TransitionValidator(cellEngine, { debug: this.verbose });
