---
source_path: /home/jake/.edwinpai/disciplines/semantos/state/semantos-core-repo/src/types/semantic-objects.d.ts
source_type: folder
memory_type: semantic_memory
ingested_at: 2026-06-13T06:27:18.400560+00:00
---

# src/types/semantic-objects.d.ts
 ...
 */
export interface LinearObject<TConsumptionProof = ConsumptionProof> extends SemanticObject {
 ...
 */
export interface RelevantObject<TRevocation = RevocationProof> extends SemanticObject {
 ...
 */
export declare function isLinear<T extends SemanticObject>(obj: T): obj is T & LinearObject;
/**
 * Type guard: Check if object is AFFINE.
 */
export declare function isAffine<T extends SemanticObject>(obj: T): obj is T & AffineObject;
/**
 * Type guard: Check if object is RELEVANT.
 */
export declare function isRelevant<T extends SemanticObject>(obj: T): obj is T & RelevantObject;
//# sourceMappingURL=semantic-objects.d.ts.map
```
