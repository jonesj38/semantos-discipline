---
source_path: /home/jake/.edwinpai/disciplines/semantos/state/semantos-core-repo/core/protocol-types/src/anchor.ts
source_type: folder
memory_type: semantic_memory
ingested_at: 2026-06-13T06:27:17.853232+00:00
---
...
export async function createAnchorAdapter(config: AnchorConfig): Promise<AnchorAdapter> {
  if (config.mode === 'stub') {
    ...
    return new StubAnchorAdapter(config.interval ?? 600_000);
  }
  if (config.mode === 'bsv') {
