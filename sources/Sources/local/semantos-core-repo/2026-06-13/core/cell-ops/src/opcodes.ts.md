---
source_path: /home/jake/.edwinpai/disciplines/semantos/state/semantos-core-repo/core/cell-ops/src/opcodes.ts
source_type: folder
memory_type: semantic_memory
ingested_at: 2026-06-13T06:27:17.825122+00:00
---
...
export enum Opcode {
  ...
  OP_CHECKDOMAINFLAG = 0xc6,     // Verify domain-specific flag on cell — failure-atomic
  OP_CHECKTYPEHASH = 0xc7,       // Verify SHA-256 type hash on cell — failure-atomic
  OP_DEREF_POINTER = 0xc8,       // Dereference pointer cell via host fetch — failure-atomic

  // Host function dispatch (0xD0 range) — Phase 25.5
