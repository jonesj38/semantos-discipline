---
source_path: /home/jake/.edwinpai/disciplines/semantos/state/semantos-core-repo/packages/games/src/cards/poker-policies.ts
source_type: folder
memory_type: semantic_memory
ingested_at: 2026-06-13T06:27:17.410929+00:00
---

# packages/games/src/cards/poker-policies.ts
...
export function registerPokerHostFunctions(registry: HostFunctionRegistry): void {
  ...
  registry.register('has-chips?', (ctx) => {
    return (ctx.playerChips ?? 0) > 0 ? 1 : 0;
  });
}
