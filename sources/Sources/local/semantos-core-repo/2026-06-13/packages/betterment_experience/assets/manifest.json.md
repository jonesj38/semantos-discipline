---
source_path: /home/jake/.edwinpai/disciplines/semantos/state/semantos-core-repo/packages/betterment_experience/assets/manifest.json
source_type: folder
memory_type: semantic_memory
ingested_at: 2026-06-13T06:27:17.447099+00:00
---
...
```json
{
  ...
  "_notes": {
    ...
    "domainFlag": "0x000201 — canonical allocation for betterment (previously self; renamed 2026-05-29 to free the word 'self' for the shell identity primitive). Distinct from oddjobz (0x000101), jambox (0x000104), tessera (0x00010400).",
    "ui": "C9 PR-C9-6 (2026-05-29 per HELM-CANONICAL-SURFACE.md §2+§5): surfacingMode=default + 3 DO verbs declared. Only `release` has a wired dispatch path today; `intention` + `review` are declared so the helm shows them, but tapping them yields a 'not yet wired' placeholder. Dispatcher wire-up + per-verb input UI lands in PR-C9-7."
  }
}
