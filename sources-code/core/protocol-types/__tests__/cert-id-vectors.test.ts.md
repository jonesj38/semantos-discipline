---
source_path: /home/jake/.edwinpai/disciplines/semantos/state/semantos-core-repo/core/protocol-types/__tests__/cert-id-vectors.test.ts
source_type: folder
memory_type: semantic_memory
ingested_at: 2026-06-13T06:27:17.857799+00:00
---

# core/protocol-types/__tests__/cert-id-vectors.test.ts

```ts
/**
 * W1.5C-1 — BRC-52 cert_id cross-language conformance (canonical home).
 *
 * The canonical home for this conformance suite is @semantos/protocol-types;
 * a backward-compat copy also exists at core/plexus-contracts/tests/.
 *
 * Loads 100 deterministic vectors from
 * __tests__/vectors/cert_id_vectors.json and asserts:
 *
...
describe("W1.5C-1 cert_id conformance vectors (canonical home — @semantos/protocol-types)", () => {
...
describe("cert_id invariants (canonical home)", () => {
