---
source_path: /home/jake/.edwinpai/disciplines/semantos/state/semantos-core-repo/apps/oddjobtodd/src/components/TweaksPanel.tsx
source_type: folder
memory_type: semantic_memory
ingested_at: 2026-06-13T06:27:19.051935+00:00
---

# apps/oddjobtodd/src/components/TweaksPanel.tsx
...
export type TweakValues = { [key: string]: unknown };

export function useTweaks<T extends TweakValues>(defaults: T): [T, (key: keyof T, value: T[keyof T]) => void] {
...
export function TweakRadio({ label, value, options, onChange }: {
  ...
  const opts = options.map(([v, l]) => ({ value: v, label: l }));
