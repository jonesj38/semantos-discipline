...
shad run "$(cat '/home/jake/.edwinpai/disciplines/semantos/runs/20260613-002918/goal.txt')"   --collection semantos-discipline   --profile deep   --provider edwin-gateway   -O gpt-5.5   -W gpt-5.5   -L gpt-5.5   --max-time 10800   --output '/home/jake/.edwinpai/disciplines/semantos/runs/20260613-002918/final.report.md'
